...
export default function Register() {
    ...
    return (
        <Chakra.Box w='100%' h='100%' backgroundImage={TES_image} userSelect='none'>
            <Helmet>
                <title>Register - Tagongon Elementary School Profiling System</title>
                <meta name="description" content="Register to the Tagongon Elementary School Profiling System to manage teacher and student data efficiently." />
                <link rel="icon" type="image/svg+xml" href="/tes_logo.png" />
            </Helmet>
            <Chakra.Box w='100%' h='100%' bg='rgba(255, 255, 255, .9)' display='flex' justifyContent='center' alignItems='center' overflow='auto'>
