            ...
            <Chakra.Box w='30%' p='2%' bg='white' boxShadow='.2vw .2vw .3vw rgba(185, 186, 182, 0.5)'>
                ...
                <Chakra.Box w='100%' mt='5%' mb='5%' display='flex' alignItems='center' justifyContent='space-between'>
                    <Chakra.Box w='50%' display='flex' alignItems='center'>
                        <Chakra.Text mr='1%' fontSize='1.5vw' fontWeight='bold' color='gray.700'><TiUser /></Chakra.Text>
                        <Chakra.Text fontSize='1.2vw' fontWeight='bold' color='gray.700'>Welcome Teacher!</Chakra.Text>
                    </Chakra.Box>
                    <Chakra.Button onClick={() => navigate('/register')} h='2vw' p='2.5%' fontSize='.8vw' color='gray.700' colorScheme='gray' leftIcon={<TiUserAdd size='1.2vw' />} display='flex' alignItems='center' borderRadius='0' _hover={{ bg: '#094333', color: 'white', transition: '.3s' }} transition='.3s'>Create Account</Chakra.Button>
                </Chakra.Box>
                <hr />
                <Chakra.Box w='100%' mt='5%'>
                    <Chakra.Text fontSize='1vw' fontWeight='500' color='gray.700'>Login to your account</Chakra.Text>
