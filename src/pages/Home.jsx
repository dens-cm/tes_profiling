                ...
                loading || userLoading || fetching ? (
                    ...
                    (
                        <Chakra.Box w='100%' h='100%' bg='#f0f1f5' display='flex' alignItems='center' justifyContent='center'>
                            ...
                            <Chakra.Box w='30%' p='2%' bg='white' boxShadowc='.2vw .2vw .4vw rgb(105, 126, 116, .2)'>
                                    ...
                                    <Chakra.Text fontSize='.8vw' fontWeight='bold' color='gray.600' textTransform='uppercase' display='flex' alignItems='center'>
                                        {
                                            activeView === 'dashboard' ?
                                                (
                                                    <>
                                                        <Chakra.Text as="h1" mr='4%' fontSize='1.3vw'><TiMap /></Chakra.Text>
                                                        Dashboard
                                                    </>
                                                ) :
                                                activeView === 'profile' ?
                                                    (
                                                        <>
                                                            <Chakra.Text as="h1" mr='4%' fontSize='1.2vw'><TiUserOutline /></Chakra.Text>
                                                            Profile
                                                        </>
                                                    ) :
                                                    activeView === 'trainings' ?
                                                        (
                                                            <>
                                                                <Chakra.Text as="h1" mr='8%' fontSize='1vw'><TiThLargeOutline /></Chakra.Text>
                                                                Trainings
                                                            </>
                                                        ) : null
                                        }
